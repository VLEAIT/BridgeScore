from .common import LandType,LandGrade,RemittanceChannel,ApplicationStatus,Recommendation,AgentName,APIResponse
...
"DVAOutput","IIAOutput","CSAOutput","CAOutput","OAOutput"
]
